...
console.log(cartItems);
  return (
      ...
      <>
<nav className="fixed top-0 left-0 w-full h-13 bg-white shadow-md flex items-center justify-between px-4 z-50 ">
  ...
  {/* <li  className='' onClick={() => setIsVisible(true)}>   < IoCloseSharp className='h-[5vh] w-[10vw] lg:block lg:h-[4vh] lg:w-[4vw] z-50'/></li> */}
   <li  className='cursor-pointer' onClick={() => setIsVisible(true)}>  <MdMenu className=' text-[purple] h-[5vh] w-[10vw] lg:block lg:h-[4vh] lg:w-[4vw] z-100'/></li> 
   ...
   {isVisible && (
            ...
            <div className="flex h-full flex-col bg-white shadow-xl">
              <div className="flex-1 px-4 py-6 sm:px-6">
                <div className="flex items-start justify-between">
                  <h2 className="font-bold lg:text-2xl text-[purple] last:border-b border-black " id="slide-over-title">Menu</h2>
                ...
                <div className="mt-4 -y-4 flex flex-col">
                  ...
                  <Link href="/everyday-fits" className=" text-[#4A90E2] cursor-pointer hover:text-purple-500  font-mono py-1" onClick={toggleMenu}>Essential Tees</Link>
                  <Link href="/street-style-hoodies" className="text-[#333333] cursor-pointer hover:text-purple-500  font-mono py-1" onClick={toggleMenu}>Street Style Hoodies</Link>
                  <Link href="/outerwear" className=" text-[#6D8F6F] cursor-pointer hover:text-purple-500  font-mono py-1" onClick={toggleMenu}>Outerwear</Link>
                  <Link href="/bottoms" className="text-[#D4A373] cursor-pointer hover:text-purple-500  font-mono py-1" onClick={toggleMenu}>Bottoms</Link>
                  <Link href="/pretty-in-pink" className=" text-[#FF6B81] cursor-pointer hover:text-purple-500  font-mono py-1" onClick={toggleMenu}>Pretty in Pink</Link>
                  <Link href="/style-booster" className="text-[#E3B23C] cursor-pointer hover:text-purple-500  font-mono py-1" onClick={toggleMenu}>Style Boosters </Link>
                  <Link href="/sale" className="text-[#FF4500] cursor-pointer hover:text-purple-500  font-mono py-1" onClick={toggleMenu}>Sale</Link>
    ...
    <li className='px-4'><FaSearch className='text-[purple] h-[5vh] w-[8vw] lg:hidden lg:h-[3.5vh] lg:w-[3.5vw]'/></li>
 ...
 <img src="/images/logo.jpg" className='h-[8vh] w-full  lg:h-[20vh] lg:w-[30vw]' alt="" />
        ...
        <li className=''><FaSearch className='text-[purple] h-[5vh] w-[8vw] hidden lg:block lg:h-[3.5vh] lg:w-[3.5vw]'/></li>
          <li  className=''> <MdOutlineAccountCircle className='text-[purple] h-[5vh] w-[10vw] lg:block lg:h-[4vh] lg:w-[4vw]'/></li>
        
          <li className="relative" onClick={() => setCartMenu(true)}>
          <IoMdCart className="text-[purple] h-[5vh] w-[10vw] lg:h-[4vh] lg:w-[4vw]" />
