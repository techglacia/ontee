  ...
  />
    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <h1 className="text-4xl font-semibold mb-8 text-[purple] ">NEW ARRIVALS</h1>
        <div className="flex flex-wrap -m-4">
          {hoodies.map((hoodie) => (
            <div key={hoodie.id} className="lg:w-1/4 md:w-1/2 p-4 w-full">
              <Link href={`/new-arrival/${hoodie.id}`} legacyBehavior>
    ...
    <div>
      <img src="https://img.freepik.com/premium-photo/stylish-men-neon-purple-hoodie-neon-coral-modern-fashion-portrait-trendy-background_171965-89379.jpg" alt=""  className="w-[100vw] shadow-lg"/>
    </div>
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <h2 className="text-4xl font-semibold mb-8">Essential Tees</h2>
        <div className="flex flex-wrap -m-4">
          {hoodies.map((hoodie) => (
            <div key={hoodie.id} className="lg:w-1/4 md:w-1/2 p-4 w-full">
