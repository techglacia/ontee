...
const Checkout = () => {
  ...
  const sendEmail = (e) => {
    ...
    const templateParams = {
      ...
      postal: form.current.postal.value,
  ...
  return (
   <section className="bg-white lg:my-20 py-50 antialiased bg-gray-900 md:py-16 my-16">
      <form ref={form} onSubmit={sendEmail} className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <h2 className="text-xl font-semibold text-gray-900 text-white lg:my-10">Delivery Details</h2>
        ...
        <input type="text" name="address" placeholder="Enter your Complete Address" required className="block w-full border p-2 mb-4" />
        <input type="text" name="postal" placeholder="Enter your Postal Code" required className="block w-full border p-2 mb-4" />
